...
- Staging, `<codex-home>/corpus-staging/`, is a fourth surface beside the three `../../installing.md § Three surfaces` separates. Rebuild it from the checkout for every refresh; it is disposable processing material, never canon.
