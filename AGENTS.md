...
1. Read `README.md` and `adopting.md` for the corpus model and `installing.md` for the install model every harness shares, then `transforms/codex/README.md`, which carries the adoption sequence end to end; `transforms/codex/AGENTS.md` governs the work itself.
...
For other work, follow the user's requested scope. Guidance in a nested `AGENTS.md` governs its own subtree and supplements this repository-level routing.
